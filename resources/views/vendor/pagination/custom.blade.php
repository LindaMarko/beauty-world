  ...
  <div class="text-right">
    <div class="pagination-container">
      ...
      @if ($paginator->onFirstPage())
        <li class="prev disabled" style="display: none" aria-disabled="true" aria-label="@lang('pagination.previous')">
      ...
      @else
        <li class="next disabled" style="display: none" aria-disabled="true" aria-label="@lang('pagination.next')">

...
<!--   ------------ Add Sub Sub Category Page -------- -->
    <div class="col-12">
          ...
          <form method="post" action="{{ route('subsubcategory.update') }}" >
            ...
            <div class="form-group">
              <h5>Sub-SubCategory Swedish<span class="text-danger">*</span></h5>
              <div class="controls">
            <input type="text" name="subsubcategory_name_sv" class="form-control" value="{{ $subsubcategories->subsubcategory_name_sv }}">
              @error('subsubcategory_name_sv')
            <span class="text-danger">{{ $message }}</span>
            @enderror
              </div>
            </div>

            ...
            @foreach($sliders as $item)
              <tr>
                ...
                <td width="30%">
                  ...
                  @if($item->status == 1)
                  <a href="{{ route('slider.inactive',$item->id) }}" class="btn btn-danger btn-sm" title="Make It Inactive"><i class="fa fa-arrow-down"></i> </a>
                  @else
                  <a href="{{ route('slider.active',$item->id) }}" class="btn btn-success btn-sm" title="Make It Active"><i class="fa fa-arrow-up"></i> </a>
                   @endif
                </td>
              </tr>
              @endforeach

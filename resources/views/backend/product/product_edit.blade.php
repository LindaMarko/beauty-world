...
<!-- Content Header (Page header) -->
    ...
    <!-- Basic Forms -->
      ...
      <div class="row"> <!-- start 4th row  -->
        <div class="col-md-4">
          <div class="form-group">
          <h5>Product Tags Sv</h5>
          <div class="controls">
            <input type="text" name="product_tags_sv" class="form-control"  data-role="tagsinput">
      ...
      <div class="col-md-4">
        <div class="form-group">
          <h5>Product Size Sv</h5>
          <div class="controls">
            <input type="text" name="product_size_sv" class="form-control" data-role="tagsinput">
      ...
      <div class="row"> <!-- start 5th row  -->
        ...
        <div class="col-md-4">
          <div class="form-group">
            <h5>Product Color Sv</h5>
            <div class="controls">
              <input type="text" name="product_color_sv" class="form-control" data-role="tagsinput">
      ...
      <div class="col-md-12">
       <div class="box bt-3 border-info">
        ...
        <form method="post" action="{{ route('update-product-thumbnail') }}" enctype="multipart/form-data">
          ...
          <input type="hidden" name="id" value="{{ $product->id }}">
          <input type="hidden" name="old_img" value="{{ $product->image_link }}">
          <div class="row row-sm">
            <div class="col-md-3">
              <div class="card">
                <img src="{{ asset($product->image_link) }}" class="card-img-top" style="height: 130px; width: 280px;">
                <div class="card-body">
                  <p class="card-text">
                    <div class="form-group">
                      <label class="form-control-label">Change Image <span class="tx-danger">*</span></label>
